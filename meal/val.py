...
from meal.datasets import get_backbone_model, get_cls_model
from meal.models import MEAL, MEAL_with_masked_attention, init_model


def get_meal(model_path, model_name="MEAL"):
    if model_name == "MEAL":
